...
@section('content')
<div class="max-w-4xl mx-auto p-6" x-data="{ activeTab: 'profile' }">
    <!-- Success Messages -->
    @if(session('status'))
            ...
            <div x-show="activeTab === 'profile'" x-transition>
                ...
                <form method="POST" action="{{ route('profile.update') }}" x-data="profileForm()">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Company Name -->
                        <div>
                            <label for="company_name" class="block text-sm font-medium text-slate-200 mb-2">Company Name (Optional)</label>
