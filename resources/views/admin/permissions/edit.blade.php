<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-slate-100 leading-tight">Edit Permission</h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-800 dark:text-slate-100 p-6 rounded shadow-sm">
                <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-slate-300">Permission name</label>
                        <input id="name" 
                               name="name" 
                               type="text" 
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('admin.permissions.index') }}" class="px-4 py-2 bg-gray-200 dark:bg-slate-700 dark:text-slate-100 hover:bg-gray-300 dark:hover:bg-slate-600 rounded-lg transition">
                            Cancel
                        </a>
                    </div>
                </form>
