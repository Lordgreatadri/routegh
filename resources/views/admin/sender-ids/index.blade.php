...
<div class="container mx-auto py-8 max-w-6xl">
    <h2 class="text-2xl font-bold mb-4 text-white">All Sender IDs</h2>
    <a href="{{ route('admin.sender-ids.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">Add Sender ID</a>
        ...
        <table class="min-w-full divide-y divide-slate-700">
            ...
            <tbody class="bg-slate-800 divide-y divide-slate-700">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-slate-300">{{ $senderId->user->name ?? '-' }}</td>
                    ...
                    <td class="px-4 py-3">
                        <a href="{{ route('admin.sender-ids.edit', $senderId) }}" class="text-blue-400 hover:underline">Edit</a>
                        <form action="{{ route('admin.sender-ids.destroy', $senderId) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-6 text-center text-slate-400">No sender IDs found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
