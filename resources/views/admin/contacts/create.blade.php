<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-slate-100 leading-tight">Create New Contact</h2>
                ...
                <form action="{{ route('admin.contacts.store') }}" method="POST">
                    ...
                    <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Add Individual Contact</h3>
                                <p class="text-sm text-slate-500 dark:text-slate-400">Enter contact details to add a new contact</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                Select a group to organize this contact or leave as individual
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       required
                                       class="w-full pl-10 pr-4 py-3 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                       placeholder="e.g., 0241567890" />
                            </div>
                            <p class="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                Phone number will be automatically normalized. Must be at just 10 digits.
                            </p>
                        </div>
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-blue-900 dark:text-blue-400 mb-1">About Contact Creation</h4>
                                    <ul class="text-xs text-blue-800 dark:text-blue-300 space-y-1">
                                        <li>• The system will automatically check for duplicate phone numbers</li>
                                        <li>• You can add multiple contacts to the same group</li>
                                        <li>• For bulk imports, use the <a href="{{ route('admin.contacts.uploadForm') }}" class="underline font-medium">Upload File</a> option</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
