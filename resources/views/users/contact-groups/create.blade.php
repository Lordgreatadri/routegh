...
<div class="max-w-3xl mx-auto p-4">
    <div class="bg-slate-800 text-slate-100 shadow rounded-lg p-6">
        <h2 class="text-xl font-semibold mb-4">New Contact Group</h2>
        ...
        <form action="{{ route('contact-groups.store') }}" method="POST">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" class="mt-1 block w-full rounded p-2 border border-slate-600 bg-slate-700 text-slate-100">{{ old('description') }}</textarea>
            </div>
